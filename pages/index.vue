...
<style>
    ...
    .siteCollection__header {
        @apply flex items-center border-t border-b border-black;
    }
    .siteCollection__header--title {
        @apply w-1/3 text-3xl font-black h-full flex justify-center items-center border-l border-r border-black;
    }
    ...
    .siteCollection__item--title {
        @apply absolute top-10 w-full text-center text-3xl z-10;
    }
</style>